...
>>>>>>> 827d8e972b3f652a35396fb28635496d3911682c
				...
				if (options.debug) {
					console.log('imageTemplate initialized');
					console.groupEnd('imageTemplate');
				}
			});
		},
		destroy : function() {
		...
		getSelection : function() {
			...
			selectionObj.x2 = Math.round(selectionObj.x1 + (options.width));
			selectionObj.y2 = Math.round(selectionObj.y1 + (options.height));
			return selectionObj;
		},
